...
const double *Ellipsoid::fit_basic()
{
    ...
    parameters[0] = (maxX - minX) / 2;//gainX;
    parameters[1] = 0;
    parameters[2] = 0;
    parameters[3] = 0;
    parameters[4] = (maxY - minY) / 2;//gainY;
    parameters[5] = 0;
    parameters[6] = 0;
    parameters[7] = 0;
    parameters[8] = (maxZ - minZ) / 2;//gainZ;
    parameters[9] = (maxX + minX) / 2;//centerX;
    parameters[10] = (maxY + minY) / 2;//centerY
    parameters[11] = (maxZ + minZ) / 2;//centerZ
