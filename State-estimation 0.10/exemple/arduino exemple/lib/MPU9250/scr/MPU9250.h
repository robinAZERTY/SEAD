...
#define MAG_CALIBRATION_ADDRESS ACC_CALIBRATION_ADDRESS+acc_calib_size

#define EEPROM_SIZE MAG_CALIBRATION_ADDRESS+mag_calib_size

//modified by robinAZERTY
#include "../signal processing/scr/gyro calibration.cpp"
...
class MPU9250{
  public:
    ...
    int calibrateAccel();
    int calibrateAccel_advanced(const unsigned int numberOfSamples, const bool write_to_flash=false);
