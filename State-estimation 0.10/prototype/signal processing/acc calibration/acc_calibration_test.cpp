...
B =
  ...
  */
    ...
    accCalibration.calibrate(samples, 100);
    cout << "A = " << endl << accCalibration.ellipsoidFitting.A.to_str() << endl;
    cout << "B = " << endl << accCalibration.ellipsoidFitting.B.to_str() << endl;
    cout << "std noise = " << sqrt(accCalibration.ellipsoidFitting.minimum_cost) << endl;
