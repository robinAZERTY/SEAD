...
class Matrix
{
    public :
        ...
        void resize(const int& nb_new_rows, const int& nb_new_cols);//redimensionne la matrice
        ...
        */
        ...
        void set(const unsigned int& row, const unsigned int& col, const double &data);//affecte une valeur à une case de la matrice
