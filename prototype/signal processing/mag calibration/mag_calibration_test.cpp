...
B =
  ...
  */
    ...
    magCalibration.calibrate(samples, 100);
    cout << "A = " << endl << magCalibration.ellipsoidFitting.A.to_str() << endl;
    cout << "B = " << endl << magCalibration.ellipsoidFitting.B.to_str() << endl;
    cout << "std noise = " << sqrt(magCalibration.ellipsoidFitting.minimum_cost) << endl;
