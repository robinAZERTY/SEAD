...
const Vector accelerometer::measure(const State &robot_state, const double &time)
{   
    ...
    */  
    ...
    Vector A_2 = quaternion_to_vector(internal_orientation.conjugate() * robot_state.orientationState.q * vector_to_quaternion(A_0) * robot_state.orientationState.q.conjugate() * internal_orientation);
