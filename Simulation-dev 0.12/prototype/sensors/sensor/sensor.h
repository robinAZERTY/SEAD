...
public:
    ...
    void set_refresh_delay(const double refresh_delay[3]);
    ...
    const Vector get_samples(const Vector &physical_quantities_3Dvalue, const double &time);
